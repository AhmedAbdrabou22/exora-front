            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold mb-4">
                        <span className="bg-gradient-to-r from-[#00A4FF] to-[#1F3A93] inline-block text-transparent bg-clip-text">الأسئلة الشائعة</span>
                    </h2>
                ...
                <div className="max-w-3xl mx-auto">
                    {faqItems.map((faq, index) => (
                        <div
                            key={index}
                            className="mb-4 border border-[#1F3A93]/30 rounded-lg overflow-hidden shadow-md shadow-[#00A4FF]/5"
                        >
                            <button
                                className="w-full text-right bg-[#0A1128] px-6 py-4 flex justify-between items-center hover:bg-[#1F3A93]/10 transition-colors duration-200"
                                onClick={() => toggleAccordion(index)}
                            >
                                <span className={`transform transition-transform duration-300 ${activeIndex === index ? 'rotate-180' : ''}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#00A4FF]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <span className="font-semibold text-[#00A4FF]">{faq.question}</span>
                            </button>
                            <div
                            ...
                            >
                                <p className="px-6 text-right text-gray-300">{faq.answer}</p>
                            </div>
                        </div>
                    ))}
                </div>

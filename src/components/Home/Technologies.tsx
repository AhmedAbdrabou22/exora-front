...
const Technologies = () => {
    return (
        <div className="py-20 bg-[#0A1128]">
            <div className="container mx-auto px-4">
                {/* Section Heading with Gradient */}
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">
                        <span className="bg-gradient-to-r from-[#00A4FF] to-[#1F3A93] inline-block text-transparent bg-clip-text">Our Technologies</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Technology 1 */}
                    <div className="bg-[#0A1128] border border-[#1F3A93]/30 rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#00A4FF]/20">
                        <div className="h-2 bg-gradient-to-r from-[#1F3A93] to-[#00A4FF]"></div>
                        <div className="p-8">
                            <div className="w-16 h-16 bg-[#1F3A93] bg-opacity-20 rounded-full flex items-center justify-center mb-6 mx-auto">
                                <FaHome className="text-3xl text-[#00A4FF]" />
                            </div>
                            <h3 className="text-xl font-semibold text-center mb-4 text-white">Smart Home</h3>
                            ...
                            <div className="mt-6 text-center">
                                <a
                                    href="/technologies/smart-home"
                                    className="inline-block text-[#00A4FF] hover:text-white font-medium transition-colors duration-300"
                                >
                                    Learn More →
                                </a>
                            </div>
                    ...
                    <div className="bg-[#0A1128] border border-[#1F3A93]/30 rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#00A4FF]/20">
                        ...
                        <div className="p-8">
                            <div className="w-16 h-16 bg-[#1F3A93] bg-opacity-20 rounded-full flex items-center justify-center mb-6 mx-auto">
                                <FaIndustry className="text-3xl text-[#00A4FF]" />
                            </div>
                            <h3 className="text-xl font-semibold text-center mb-4 text-white">Industrial IoT</h3>
                            <p className="text-gray-300 text-center">
                                Optimize operations and increase efficiency with our industrial IoT solutions. Monitor equipment, analyze data, and automate processes.
                            </p>
                            <div className="mt-6 text-center">
                    ...
                    <div className="bg-[#0A1128] border border-[#1F3A93]/30 rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#00A4FF]/20">
                        ...
                        <div className="p-8">
                            <div className="w-16 h-16 bg-[#1F3A93] bg-opacity-20 rounded-full flex items-center justify-center mb-6 mx-auto">
                                <FaLeaf className="text-3xl text-[#00A4FF]" />
                            </div>
                            <h3 className="text-xl font-semibold text-center mb-4 text-white">Smart Agriculture</h3>
                            <p className="text-gray-300 text-center">
                                Revolutionize farming with precision agriculture technology. Monitor soil conditions, automate irrigation, and optimize crop yields.
                            </p>
                            <div className="mt-6 text-center">

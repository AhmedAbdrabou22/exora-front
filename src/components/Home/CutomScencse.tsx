...
const CustomScenes = () => {
  ...
  return (
    <div className="py-12 md:py-20 bg-[#0A1128]">
      <div className="container mx-auto px-4">
        {/* Section Heading with Gradient */}
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">
            <span className="bg-gradient-to-r from-[#00A4FF] to-[#1F3A93] inline-block text-transparent bg-clip-text">Custom Scenes & Routines</span>
          </h2>
        ...
        <div className="flex overflow-x-auto pb-2 md:pb-0 md:flex-wrap justify-start md:justify-center gap-2 md:gap-4 mb-6 md:mb-10 no-scrollbar">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex-shrink-0 flex items-center gap-2 px-3 md:px-4 py-2 md:py-3 rounded-lg transition-all duration-300 text-sm md:text-base ${
                activeTab === tab.id
                  ? "bg-gradient-to-r from-[#1F3A93] to-[#00A4FF] text-white shadow-lg border-2 border-[#00A4FF] transform scale-105"
                  : "bg-[#0A1128] text-gray-300 border-2 border-[#1F3A93]/30 hover:border-[#00A4FF] hover:text-[#00A4FF]"
              }`}
            >
              <span className="text-lg md:text-xl">{tab.icon}</span>
              <span className="font-medium whitespace-nowrap">{tab.title}</span>
        ...
        {/* Tab Content with Image and Overlay - Adjusted for better mobile display */}
        <div className="relative rounded-xl overflow-hidden shadow-xl group transition-all duration-500 max-w-5xl mx-auto border border-[#1F3A93]/30">
          {/* Dark Overlay that lightens on hover */}
          <div className="absolute inset-0 bg-black opacity-70 group-hover:opacity-50 transition-opacity duration-500 z-10"></div>
          ...
          {/* Content Overlay - Improved for mobile */}
          <div className="absolute inset-0 z-20 flex items-center justify-center p-3 sm:p-5 md:p-8">
            <div className="bg-[#0A1128] bg-opacity-90 p-3 sm:p-4 md:p-6 lg:p-8 rounded-lg w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl text-white transform transition-all duration-500 group-hover:scale-105 overflow-y-auto max-h-[280px] sm:max-h-[380px] md:max-h-[460px] border border-[#1F3A93]/30 shadow-lg shadow-[#00A4FF]/10">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3 md:mb-4 text-[#00A4FF]">
                {tabs[activeTab].content.title}
              </h3>
              ...
              <div className="mt-4 sm:mt-6 md:mt-8">
                <button className="bg-gradient-to-r from-[#1F3A93] to-[#00A4FF] hover:from-[#00A4FF] hover:to-[#1F3A93] text-white py-1.5 sm:py-2 px-4 sm:px-6 rounded-full transition-all duration-300 text-sm sm:text-base shadow-md hover:shadow-lg hover:shadow-[#00A4FF]/20">
                  Set Up This Scene
                </button>
              </div>
            </div>

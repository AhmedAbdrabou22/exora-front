...
const HeroSmartSurv = () => {
    ...
    return (
        <div
            ref={containerRef}
            className="relative w-full h-screen overflow-hidden bg-[#0A1128] flex items-center justify-center"
        >
            ...
            >
                {/* TV outer frame */}
                <div className="w-[500px] h-[350px] md:w-[600px] md:h-[400px] lg:w-[700px] lg:h-[450px] bg-gradient-to-b from-[#333] to-[#111] rounded-[30px] p-[15px] shadow-[0_0_40px_rgba(0,164,255,0.3)] flex flex-col">
                    {/* TV screen */}
                    <div className="flex-1 bg-black rounded-[15px] overflow-hidden relative">
                        {/* Surveillance grid display */}
                        <div className="w-full h-full grid grid-cols-2 grid-rows-2 gap-1 p-2">
                            {/* Camera feed 1 */}
                            <div className="relative overflow-hidden rounded-md bg-[#0A1128]">
                                <img 
                                ...
                                />
                                <div className="absolute top-2 left-2 text-xs text-white/70 bg-black/50 px-2 py-1 rounded">CAM 01</div>
                            ...
                            <div className="relative overflow-hidden rounded-md bg-[#0A1128]">
                                ...
                                />
                                <div className="absolute top-2 left-2 text-xs text-white/70 bg-black/50 px-2 py-1 rounded">CAM 02</div>
                                <div className="absolute bottom-2 right-2 text-xs text-red-500 flex items-center">
                                    <span className="w-2 h-2 bg-red-500 rounded-full mr-1 animate-pulse"></span>
                                    REC
                                </div>
                            ...
                            <div className="relative overflow-hidden rounded-md bg-[#0A1128]">
                                ...
                                />
                                <div className="absolute top-2 left-2 text-xs text-white/70 bg-black/50 px-2 py-1 rounded">CAM 03</div>
                                <div className="absolute bottom-2 right-2 text-xs text-red-500 flex items-center">
                                    <span className="w-2 h-2 bg-red-500 rounded-full mr-1 animate-pulse"></span>
                                    REC
                                </div>
                            ...
                            <div className="relative overflow-hidden rounded-md bg-[#0A1128]">
                                ...
                                />
                                <div className="absolute top-2 left-2 text-xs text-white/70 bg-black/50 px-2 py-1 rounded">CAM 04</div>
                                <div className="absolute bottom-2 right-2 text-xs text-red-500 flex items-center">
                                    <span className="w-2 h-2 bg-red-500 rounded-full mr-1 animate-pulse"></span>
                                    REC
                                </div>
                    ...
                    <div className="h-[20px] mt-2 flex justify-center">
                        <div className="w-[100px] h-full bg-gradient-to-b from-[#333] to-[#111] rounded-b-lg"></div>
                    </div>
                </div>
            </div>
        </div>

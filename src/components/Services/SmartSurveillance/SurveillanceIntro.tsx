                            ...
                            <div className={`relative p-6 rounded-lg shadow-lg transition-all duration-500 ${
                                ...
                                <div className="flex justify-center">
                                    <button className={`px-6 py-3 rounded-lg transition-all duration-300 shadow-lg flex items-center gap-2 transform hover:scale-105 ${
                                        ...
                                        <span className="text-right">احصل على استشارة مجانية</span>
                    ...
                    <div className="md:w-1/2 text-right">
                        ...
                        <div className={`p-6 rounded-lg shadow-lg transition-all duration-500 ${
                            ...
                            <ul className="space-y-3 text-right">
                                <li className={`flex items-center justify-start gap-2 transition-colors duration-500 ${
                                    ...
                                    <span className="text-right">تأمين المكان من السرقة أو التعدي</span>
                                ...
                                <li className={`flex items-center justify-start gap-2 transition-colors duration-500 ${
                                    ...
                                    <span className="text-right">مراقبة حية من أي مكان في العالم عبر تطبيق على الموبايل أو الكمبيوتر</span>
                                ...
                                <li className={`flex items-center justify-start gap-2 transition-colors duration-500 ${
                                    ...
                                    <span className="text-right">تسجيل الفيديوهات لمراجعة الأحداث لاحقًا</span>
                                ...
                                <li className={`flex items-center justify-start gap-2 transition-colors duration-500 ${
                                    ...
                                    <span className="text-right">إرسال تنبيهات فورية عند اكتشاف حركة أو أي نشاط غير طبيعي</span>
                                ...
                                <li className={`flex items-center justify-start gap-2 transition-colors duration-500 ${
                                    ...
                                    <span className="text-right">راحة بال لصاحب المكان لأنه عارف إيه اللي بيحصل في أي وقت</span>
